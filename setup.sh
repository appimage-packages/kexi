...
set -x
export PATH=/opt/usr/bin:/root/.rbenv/bin:/root/.rbenv/shims:$PATH
export CPATH=/opt/usr/include/gstreamer-1.0:/opt/usr/include:/opt/usr/include/python3.5:/usr/include:/usr/include/postgresql/9.4/server:/usr/include/postgresql
